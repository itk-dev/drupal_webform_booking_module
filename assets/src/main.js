...
function buildCalendar(
  ...
  document.getElementsByClassName("loader")[0].classList.add("showing"); // Move to loading method on calendar once load flow is changed.
 ...
 *   Drupal backend.
 */
function filterSelectedResourceBackend(element) {
