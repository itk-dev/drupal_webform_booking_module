...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AbstractResourceDayTableModel": () => (/* binding */ AbstractResourceDayTableModel),
/* harmony export */   "DEFAULT_RESOURCE_ORDER": () => (/* binding */ DEFAULT_RESOURCE_ORDER),
/* harmony export */   "DayResourceTableModel": () => (/* binding */ DayResourceTableModel),
/* harmony export */   "ResourceApi": () => (/* binding */ ResourceApi),
/* harmony export */   "ResourceDayHeader": () => (/* binding */ ResourceDayHeader),
/* harmony export */   "ResourceDayTableModel": () => (/* binding */ ResourceDayTableModel),
/* harmony export */   "ResourceLabelRoot": () => (/* binding */ ResourceLabelRoot),
/* harmony export */   "ResourceSplitter": () => (/* binding */ ResourceSplitter),
/* harmony export */   "VResourceJoiner": () => (/* binding */ VResourceJoiner),
/* harmony export */   "VResourceSplitter": () => (/* binding */ VResourceSplitter),
/* harmony export */   "buildResourceFields": () => (/* binding */ buildResourceFields),
/* harmony export */   "buildRowNodes": () => (/* binding */ buildRowNodes),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "flattenResources": () => (/* binding */ flattenResources),
/* harmony export */   "getPublicId": () => (/* binding */ getPublicId),
/* harmony export */   "isGroupsEqual": () => (/* binding */ isGroupsEqual)
/* harmony export */ });
/* harmony import */ var _fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fullcalendar/common */ "./node_modules/@fullcalendar/common/main.js");
...
var ResourceDayTableJoiner = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__extends)(ResourceDayTableJoiner, _super);
    ...
    ResourceDayTableJoiner.prototype.transformSeg = function (seg, resourceDayTableModel, resourceI) {
        ...
        return colRanges.map(function (colRange) { return ((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({}, seg), colRange), { isStart: seg.isStart && colRange.isStart, isEnd: seg.isEnd && colRange.isEnd })); });
    };
...
var ResourceDayTable = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__extends)(ResourceDayTable, _super);
    ...
    ResourceDayTable.prototype.render = function () {
        ...
        this.slicers = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.mapHash)(splitProps, function (split, resourceId) { return _this.slicers[resourceId] || new _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_3__.DayTableSlicer(); });
        var slicedProps = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.mapHash)(this.slicers, function (slicer, resourceId) { return slicer.sliceProps(splitProps[resourceId], dateProfile, nextDayThreshold, context, resourceDayTableModel.dayTableModel); });
        return ((0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_3__.Table, (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__assign)({ forPrint: props.forPrint, ref: this.tableRef }, this.joiner.joinProps(slicedProps, resourceDayTableModel), { cells: resourceDayTableModel.cells, dateProfile: dateProfile, colGroupNode: props.colGroupNode, tableMinWidth: props.tableMinWidth, renderRowIntro: props.renderRowIntro, dayMaxEvents: props.dayMaxEvents, dayMaxEventRows: props.dayMaxEventRows, showWeekNumbers: props.showWeekNumbers, expandRows: props.expandRows, headerAlignElRef: props.headerAlignElRef, clientWidth: props.clientWidth, clientHeight: props.clientHeight, isHitComboAllowed: this.isHitComboAllowed })));
    };
    return ResourceDayTable;
}(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.DateComponent));

var ResourceDayTableView = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__extends)(ResourceDayTableView, _super);
    function ResourceDayTableView() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.flattenResources = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(_fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.flattenResources);
        _this.buildResourceDayTableModel = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(buildResourceDayTableModel);
...
function buildResourceDayTableModel(dateProfile, dateProfileGenerator, resources, datesAboveResources, context) {
    var dayTable = (0,_fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_3__.buildDayTableModel)(dateProfile, dateProfileGenerator);
    return datesAboveResources ?
        new _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.DayResourceTableModel(dayTable, resources, context) :
        new _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.ResourceDayTableModel(dayTable, resources, context);
}

var main = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createPlugin)({
    deps: [
        _fullcalendar_premium_common__WEBPACK_IMPORTED_MODULE_1__["default"],
        _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__["default"],
...
/* harmony import */ var _fullcalendar_resource_daygrid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fullcalendar/resource-daygrid */ "./node_modules/@fullcalendar/resource-daygrid/main.js");
/*!
FullCalendar Scheduler v5.10.2
Docs & License: https://fullcalendar.io/scheduler
(c) 2021 Adam Shaw
...
var ResourceDayTimeColsJoiner = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__extends)(ResourceDayTimeColsJoiner, _super);
    ...
    ResourceDayTimeColsJoiner.prototype.transformSeg = function (seg, resourceDayTable, resourceI) {
        return [
            (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)({}, seg), { col: resourceDayTable.computeCol(seg.col, resourceI) }),
        ];
    };
...
var ResourceDayTimeCols = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__extends)(ResourceDayTimeCols, _super);
    function ResourceDayTimeCols() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.buildDayRanges = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(_fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__.buildDayRanges);
        _this.splitter = new _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.VResourceSplitter();
        _this.slicers = {};
    ...
    ResourceDayTimeCols.prototype.render = function () {
        ...
        var splitProps = this.splitter.splitProps(props);
        this.slicers = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.mapHash)(splitProps, function (split, resourceId) { return _this.slicers[resourceId] || new _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__.DayTimeColsSlicer(); });
        var slicedProps = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.mapHash)(this.slicers, function (slicer, resourceId) { return slicer.sliceProps(splitProps[resourceId], dateProfile, null, context, dayRanges); });
        return ( // TODO: would move this further down hierarchy, but sliceNowDate needs it
        (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.NowTimer, { unit: options.nowIndicator ? 'minute' : 'day' }, function (nowDate, todayRange) { return ((0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__.TimeCols, (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)({ ref: _this.timeColsRef }, _this.joiner.joinProps(slicedProps, resourceDayTableModel), { dateProfile: dateProfile, axis: props.axis, slotDuration: props.slotDuration, slatMetas: props.slatMetas, cells: resourceDayTableModel.cells[0], tableColGroupNode: props.tableColGroupNode, tableMinWidth: props.tableMinWidth, clientWidth: props.clientWidth, clientHeight: props.clientHeight, expandRows: props.expandRows, nowDate: nowDate, nowIndicatorSegs: options.nowIndicator && _this.buildNowIndicatorSegs(nowDate), todayRange: todayRange, onScrollTopRequest: props.onScrollTopRequest, forPrint: props.forPrint, onSlatCoords: props.onSlatCoords, isHitComboAllowed: _this.isHitComboAllowed }))); }));
    };
...
var ResourceDayTimeColsView = /** @class */ (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__extends)(ResourceDayTimeColsView, _super);
    function ResourceDayTimeColsView() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.flattenResources = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(_fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.flattenResources);
        _this.buildResourceTimeColsModel = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(buildResourceTimeColsModel);
        _this.buildSlatMetas = (0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.memoize)(_fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__.buildSlatMetas);
        return _this;
    }
    ResourceDayTimeColsView.prototype.render = function () {
        ...
        var headerContent = options.dayHeaders && ((0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.ResourceDayHeader, { resources: resources, dates: resourceDayTableModel.dayTableModel.headerDates, dateProfile: dateProfile, datesRepDistinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
        var allDayContent = (options.allDaySlot !== false) && (function (contentArg) { return ((0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(_fullcalendar_resource_daygrid__WEBPACK_IMPORTED_MODULE_4__.ResourceDayTable, (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)({}, splitProps.allDay, { dateProfile: dateProfile, resourceDayTableModel: resourceDayTableModel, nextDayThreshold: options.nextDayThreshold, tableMinWidth: contentArg.tableMinWidth, colGroupNode: contentArg.tableColGroupNode, renderRowIntro: hasAttachedAxis ? _this.renderTableRowAxis : null, showWeekNumbers: false, expandRows: false, headerAlignElRef: _this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint }, _this.getAllDayMaxEventProps()))); });
        var timeGridContent = function (contentArg) { return ((0,_fullcalendar_common__WEBPACK_IMPORTED_MODULE_0__.createElement)(ResourceDayTimeCols, (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__assign)({}, splitProps.timed, { dateProfile: dateProfile, axis: hasAttachedAxis, slotDuration: options.slotDuration, slatMetas: slatMetas, resourceDayTableModel: resourceDayTableModel, tableColGroupNode: contentArg.tableColGroupNode, tableMinWidth: contentArg.tableMinWidth, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, onSlatCoords: _this.handleSlatCoords, expandRows: contentArg.expandRows, forPrint: props.forPrint, onScrollTopRequest: _this.handleScrollTopRequest }))); };
...
function buildResourceTimeColsModel(dateProfile, dateProfileGenerator, resources, datesAboveResources, context) {
    var dayTable = (0,_fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_3__.buildTimeColsModel)(dateProfile, dateProfileGenerator);
    return datesAboveResources ?
        new _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.DayResourceTableModel(dayTable, resources, context) :
        new _fullcalendar_resource_common__WEBPACK_IMPORTED_MODULE_2__.ResourceDayTableModel(dayTable, resources, context);
}
...
function setupCalendar(
  ...
  const calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarElement, {
    ...
    plugins: [
      _fullcalendar_resource_timegrid__WEBPACK_IMPORTED_MODULE_6__["default"],
